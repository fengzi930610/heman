<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"C:\phpStudy\PHPTutorial\WWW\heman/application/admin\view\index\index.html";i:1553850859;s:68:"C:\phpStudy\PHPTutorial\WWW\heman/application/admin\view\layout.html";i:1533190359;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
	<head>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-brand">
			...
			<dd>
				<ul>
					<li><a href="<?php echo url('admin/brand/brandList'); ?>" title="品牌列表">品牌列表</a></li>
